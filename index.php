            ...
            <div class="row"> 
                <marquee scrolldelay="-1" scrollamount="7" loop="infinite" onmouseout="this.start()" onmouseover="this.stop()">
                    ...
                    <a href="http://www.monroe.com.mx/home/reflex" target="_blank">
                        <img class="img-rounded" style="margin-right: 15px;" title="Reflex" alt="Titulo de la entrada"  src="imgs/minis/minis monroe/m2.png"/></a>
                    <a href="http://www.monroe.com.mx/home/max_air" target="_blank">
                        <img class="img-rounded" style="margin-right: 15px;" title="Max-Air" alt="Titulo de la entrada"  src="imgs/minis/minis monroe/m3.png"/></a>
                    <a href="http://www.monroe.com.mx/home/max_lift" target="_blank">
                        <img class="img-rounded" style="margin-right: 15px;" title="Max Lift" alt="Titulo de la entrada"  src="imgs/minis/minis monroe/m4.png"/></a>
                    <a href="http://www.monroe.com.mx/home/gas_magnum" target="_blank">
                        <img class="img-rounded" style="margin-right: 15px;" title="Gas-Magnum" alt="Titulo de la entrada"  src="imgs/minis/minis monroe/m5.png"/></a>
                    <a href="http://www.monroe.com.mx/home/monro_matic_plus" target="_blank">
                        <img class="img-rounded" style="margin-right: 15px;" title="Monro-Matic Plus" alt="Titulo de la entrada"  src="imgs/minis/minis monroe/m6.png"/></a>
                    <a href="http://www.monroe.com.mx/home/sensa_trac" target="_blank">
                        <img class="img-rounded" style="margin-right: 15px;" title="Sensa-Trac" alt="Titulo de la entrada"  src="imgs/minis/minis monroe/m7.png"/></a>
                </marquee>
